 ...
 *
 * Exit code 1 if any of the four immutable headline numbers drift from the
 * expected values for this exact cohort (seed 20260904).
 */
...
const expected = {
  ...
  falseClosures: 0,
  closeRecall: 1,          // 97/97 = 100% strict recall
  closePrecision: 1,       // 97/97 = 100% precision
  hardExceptionRecall: 1,  // 20/20 = 100%
} as const;
